...
#ifndef __STM32F411XE_AUDIO_EX_H
#define __STM32F411XE_AUDIO_EX_H
...
void    BSP_AUDIO_OUT_ClockConfig(I2S_HandleTypeDef *hsai, uint32_t AudioFreq, void *Params);
void    BSP_AUDIO_OUT_MspInit(I2S_HandleTypeDef *hsai, void *Params);
void    BSP_AUDIO_OUT_MspDeInit(I2S_HandleTypeDef *hsai, void *Params);
/**
  * @}
  */ 
